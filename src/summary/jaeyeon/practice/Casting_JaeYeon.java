package summary.jaeyeon.practice;

import java.util.Scanner;



public class Casting_JaeYeon {


String isChar(String str) {
	//if()
	return str;
}
 ...
 */
	...
	public static String castToChar()
	{
		...
		String selectedCharecter = scanner.next();	// 사용자가 선택한 번호.
		
		System.out.println(selectedCharecter);
		System.out.println("hashcode" + selectedCharecter.hashCode());
		
		String msg = "";
		
		if(selectedCharecter.hashCode() >= 0 && selectedCharecter.hashCode() <= 65535) {
			msg += "  char 타입 변환 가능   ";
		}else {
			msg += " char 타입으로 변환 가능한 범위를 벗어납니다.";
		}
		/*
	...
	public static String castToInteger()
	{
		...
		String selectedNumber = scanner.next();	// 사용자가 선택한 번호.
		String msg = "";
		System.out.println(selectedNumber.hashCode());
		if(selectedNumber.hashCode() >= 0 && selectedNumber.hashCode() <= 65535) {
			
			msg += "   char 타입 변환 가능     ";
			
		}else if(selectedNumber.hashCode() >= -128 && selectedNumber.hashCode() <= 127)  {
			
			msg += "   byte 타입 변환 가능    ";
			
		}else  if(selectedNumber.hashCode() >= -32768 && selectedNumber.hashCode() <= 32767)  {
