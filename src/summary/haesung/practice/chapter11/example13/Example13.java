package summary.haesung.practice.chapter11.example13;
 ...
 * Author 	: pureboyz
 * 
 * 다음 코드는 문제11-12를 발전시킨 것으로 각 Player들의 점수를 계산하고, 점수가 제일 높은 사람을 출력하는 코드이다.
			...
			public int compare(Object o1, Object o2)
			{
				...
				*/
				if((o1 instanceof Player) && (o2 instanceof Player))
				{
					...
					return String.valueOf(p1.point).compareTo(String.valueOf(p2.point)) * (-1);
				}
